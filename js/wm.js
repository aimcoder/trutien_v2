...
(function () {
    ...
    var top_ad = [
     	{ srcsmall: u + "images/top/top2018/wanmei_gg_small_20180921.jpg?v=1", srcbig: u + "images/top/top2018/wanmei_gg_big_20180921.jpg?v=1", href: "http://xa.wanmei.com/" },
...
//      { srcsmall: u + "images/top/top2017/wanmei_gg_small_20170904.jpg?v=1", srcbig: u + "images/top/top2017/wanmei_gg_big_20170904.jpg?v=1", href: "http://xa.wanmei.com/" }
    ...
    var Global = {
        'top': [
			...
			{ name: 't', acc: false, skin: 1, pay:'http://yeyou.wanmei.com/billing/charge?gameId=36&serverNo=all', bbs: false, ad: 1 }
        ],
        'bottom': [
		{ name: 'wanmei', skin: 1 },
		{ name: 'sg', skin: 4 },
    ...
    var bottom_css = {
        ...
        copyright2: 'position:absolute;z-index:103;height:20px;left:245px;top:92px;font-size:12px;',
    ...
    function creBottom(bottomTypeValue) {
    	...
    	if (bottomTypeValue == 'hex') {
	        ...
	        str += '<div style="' + bottom_css.copyright2 + '" class="wm_bottom_copyright">' + 'Copyright © 2008-2020 Beijing Perfect World Network Technology Co., Ltd. All Rights reserved.' + unescape('%u5B8C%u7F8E%u4E16%u754C%uFF08%u5317%u4EAC%uFF09%u7F51%u7EDC%u6280%u672F%u6709%u9650%u516C%u53F8%20%20%u7248%u6743%u6240%u6709') + '</div>';
    	}
    	str += '</div>'
	    str += '</div>';
        return str;
